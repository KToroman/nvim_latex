...
- `@.opencode/context/core/patterns/anti-stop-patterns.md` - Anti-stop patterns (apply when creating new agents/skills)
...
- When discussing templates: `@.opencode/context/core/templates/thin-wrapper-skill.md`, `@.opencode/context/core/templates/agent-template.md`
...
```json
{
  ...
  "options": [
    ...
    { "label": "Add a new skill or agent", "description": "Create execution components" },
    {
      ...
      "description": "Modify existing commands/skills/agents"
    },
    {
      "label": "Create documentation or rules",
      "description": "Add guides, rules, or context files"
    },
...
- Keywords: "command", "skill", "agent", "meta", ".opencode/" -> language = "meta"
- Keywords: "astro", "tailwind", "web", "css", "html" -> language = "web"
...
- Language indicators: "neovim", "plugin", "command", "skill", "astro", "tailwind", etc.
